...
function usa(){
  ...
  let pastGuesses = [];
    ...
    con(contador);  
      ...
      Ship.numberOfShips = 0;
      let jdnavy = new Ship("JD Navy", 2);
      let fragatawil = new Ship("Fragata Will", 1);
      let pwromanian = new Ship("PW Romanian", 1);
     

      let shipList = [jdnavy, fragatawil, pwromanian];
...
function colombia(){
  ...
  Ship.numberOfShips = 0;
  let jdnavy = new Ship("JD Navy", 2);
  let fragatawil = new Ship("Fragata Will", 2);
  let cbvictoria = new Ship("C.B Victoria", 1); 

  let shipList = [jdnavy, fragatawil, cbvictoria];
...
function china(){
  ...
  Ship.numberOfShips = 0;
  let jdnavy = new Ship("JD Navy", 2);
  let pwromanian = new Ship("PW Romanian", 2);
 

  let shipList = [jdnavy, pwromanian];
...
function australia(){
  ...
  Ship.numberOfShips = 0;
  let jdnavy = new Ship("JD Navy", 3);
  let fragatawil = new Ship("Fragata Will", 5);
  let cbvictoria = new Ship("C.B Victoria", 4);
  let pwromanian = new Ship("PW Romanian", 2);
 

  let shipList = [jdnavy, fragatawil, cbvictoria, pwromanian];
